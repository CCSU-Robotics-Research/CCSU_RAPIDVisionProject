MODULE CCSU_Vision
    ...
    TASK PERS wobjdata UpdatedWObj:=[FALSE,TRUE,"",[[0,0,0],[1,0,0,0]],[[15.0994,-459.916,273.96],[0.0061893,-0.990583,-0.136744,-0.00297907]]];
    ...
    PROC VisionUpdateWObj(num offset)
        ...
        RotationZ := EulerZYX(\Z,PartWObj.oframe.rot)+DeltaRotationZ+offset;
